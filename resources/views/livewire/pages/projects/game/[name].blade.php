...
<x-guest-layout class="w-full h-full absolute bg-black m-0 p-0 overscroll-none">
    <div class="w-full h-full relative" id="container">
        <div class="w-full h-full absolute top-0 left-0" id="game-ui">
            <div class="absolute left-24 bottom-12 bg-[rgba(1.0, 1.0, 1.0, 0.0)] w-96 h-32 py-3 rounded-xl">
                <div class="flex flex-col justify-end w-full h-full border-4 rounded-md shadow-lg left-ui-area"
                     id="left-ui-area">
                    <div class="w-full h-full flex flex-row justify-center items-end">
                        ...
                        <div class="h-full flex flex-col justify-center items-center">
                            <div
                                class="bg-[url({{ Storage::url('/projects/game/ui/flash_on_FILL0_wght700_GRAD0_opsz48.svg') }})] bg-contain h-6 w-6 ml-0.5 invert drop-shadow"></div>
                            <div
                                class="bg-[url({{ Storage::url('/projects/game/ui/add_box_FILL0_wght700_GRAD0_opsz48.svg') }})] bg-contain h-6 w-6 ml-0.5 invert drop-shadow"></div>
                        </div>
                        <div class="h-full flex flex-col justify-center items-center">
            ...
            <div class="absolute w-96 h-28 pt-2 pr-2 rounded-lg right-28 bottom-64 bg-transparent">
                <div
                    class="flex w-full h-full flex-col justify-end rounded shadow-md transform perspective-600 rotate-y-30 rotate-z-3"
                    id="right-ui-area">
                    <div class="w-full h-full flex flex-row justify-center items-end">
                        ...
                        <div class="h-full flex flex-col justify-center items-center ml-2">
                            <div
                                class="bg-[url({{ Storage::url('/projects/game/ui/currency_yuan_FILL0_wght700_GRAD0_opsz48.svg') }})] bg-no-repeat bg-cover h-6 w-6 ml-0.5 invert drop-shadow min-h-[30px]"></div>
                            <div
            ...
            <div class="absolute right-28 top-12 bg-transparent w-96 h-28 pt-2.5 pr-2.5">
                <div
                    class="flex w-full h-full flex-col justify-end rounded shadow-md transform perspective-600 -rotate-y-45 -rotate-z-3"
