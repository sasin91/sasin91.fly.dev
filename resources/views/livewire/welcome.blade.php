...
use App\Livewire\Forms\CreateContactRequestForm;
...
new #[Layout('layouts.guest')] class extends Component {
    ...
    public CreateContactRequestForm $contactForm;
    ...
    public function clearFormAndHideModal()
    {
        $this->contactForm->reset();

        $this->dispatch('close', 'contact-form-success-modal');
    }
}
?>
...
<div>
    ...
    <!-- Features section -->
    <section class="pb-8 mt-32 overflow-hidden sm:mt-40">
    ...
    <section
        ...
        <svg
            class="absolute inset-0 -z-10 h-full w-full stroke-gray-200 [mask-image:radial-gradient(100%_100%_at_top_right,skyblue,transparent)]"
            aria-hidden="true">
            <defs>
                    ...
                    <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                        <div>
                            ...
                            <x-text-input
                                ...
                                wire:model="contactForm.companyName"
                                required
                                autocomplete="organization"/>

                            <x-input-error class="mt-2" :messages="$errors->get('contactForm.companyName')"/>
                        </div>
                        <div>
                            ...
                            <x-text-input
                                ...
                                type="text"
                                class="block w-full mt-1"
                                wire:model="contactForm.contactPerson"
                                required autocomplete="fullname"/>

                            <x-input-error class="mt-2" :messages="$errors->get('contactForm.contactPerson')"/>
                        </div>
                        <div>
                            ...
                            <x-input-error class="mt-2" :messages="$errors->get('contactForm.email')"/>
                        </div>
                        <div>
                            ...
                            <x-input-error class="mt-2" :messages="$errors->get('contactForm.phone')"/>
                        </div>
                        <div class="sm:col-span-2">
                            ...
                            <x-input-error class="mt-2" :messages="$errors->get('contactForm.message')"/>
                        </div>
                    </div>
                    <div class="mt-10">
                        <button type="submit"
            ...
            <x-modal name="contact-form-success-modal" focusable>
                ...
                <div class="mt-5 sm:mt-6">
                    <button type="button"
                            ...
                            wire:click="clearFormAndHideModal"
