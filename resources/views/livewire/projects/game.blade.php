@push('scripts')
    <script type="module">
        ...
        const gameChannel = window.Echo.channel('game');

        gameChannel.listen('PlayerOnline', (player) => {
        ...
        gameChannel.listen('PlayerOffline', ({
            id,
            name
        }) => {
            console.log({
...
<div class="w-full h-full relative" id="container" wire:ignore>
    <div class="w-full h-full absolute top-0 left-0" id="game-ui">
            ...
            <div class="flex flex-col justify-end w-full h-full border-4 rounded-md shadow-lg left-ui-area"
                ...
                <div class="w-full h-full flex flex-row justify-center items-end">
                    <div class="h-full flex flex-col justify-center items-center">
                        <div class="text-white text-shadow text-4xl" id="health">
                            {{ number_format($this->player->health, 0) }}</div>
                        <div class="text-white text-shadow text-4xl" id="mana">
                            {{ number_format($this->player->mana, 0) }}</div>
                    </div>
                    <div class="h-full flex flex-col justify-center items-center">
                        <div
        ...
        <div class="absolute w-96 h-28 pt-2 pr-2 rounded-lg right-28 bottom-64 bg-transparent">
            <div class="flex w-full h-full flex-col justify-end rounded shadow-md transform perspective-600 rotate-y-30 rotate-z-3"
                id="right-ui-area">
                <div class="w-full h-full flex flex-row justify-center items-end">
        ...
        <div class="absolute right-28 top-12 bg-transparent w-96 h-28 pt-2.5 pr-2.5">
            <div class="flex w-full h-full flex-col justify-end rounded shadow-md transform perspective-600 -rotate-y-45 -rotate-z-3"
